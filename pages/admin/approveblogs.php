...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="approveblogs.php"><i class="fa fa-edit fa-fw"></i> View Blogs</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><?php echo 'Welcome '.$_SESSION['username'];?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="row">
				...
				<?php
						...
						if ($count>=1) {
							...
							echo '<a href="blogok.php?id='.$id.'">Approve</a><br />';
							}}else {header('Location:approveblogs.php');}
						} else {
						$sql = 'select * from blogs where status=0';
						$pds = $pdo->prepare($sql);
						$pds->execute();
